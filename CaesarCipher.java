...
public class CaesarCipher {
    ...
    //The code provides public methods to encrypt or decrypt one single character encryptLetter 
    //and decryptLetter:
    ...
    public void test() {
        System.out.println("encryptLetter (a): " + encryptLetter ('a'));
        System.out.println("decryptLetter (d): " + decryptLetter ('d'));
        System.out.println("encrypt (abc): " + encrypt ("abc"));
        System.out.println("decrypt (def): " + decrypt ("def"));        
    }
}
